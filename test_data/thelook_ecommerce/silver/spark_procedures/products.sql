CREATE OR REPLACE PROCEDURE `REDACTED_PROJECT.silver.transform_products`()
...
bq_client.query("EXPORT TABLE METADATA FROM `REDACTED_PROJECT.silver.products`").result()
""";
