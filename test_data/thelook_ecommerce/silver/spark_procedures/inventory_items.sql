CREATE OR REPLACE PROCEDURE `REDACTED_PROJECT.silver.transform_inventory_items`()
...
bq_client.query("EXPORT TABLE METADATA FROM `REDACTED_PROJECT.silver.inventory_items`").result()
""";
