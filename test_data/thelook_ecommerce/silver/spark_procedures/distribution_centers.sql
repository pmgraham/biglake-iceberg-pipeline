CREATE OR REPLACE PROCEDURE `REDACTED_PROJECT.silver.transform_distribution_centers`()
...
bq_client.query("EXPORT TABLE METADATA FROM `REDACTED_PROJECT.silver.distribution_centers`").result()
""";
